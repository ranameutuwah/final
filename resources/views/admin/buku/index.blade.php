@extends('layouts.app', ['title' => 'Buku - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.buku.create') }}">TAMBAH</a>
            </button>
                    ...
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">NOMOR BUKU</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                            ...
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">TAHUN TERBIT</span>
                            </th>
                            <th class="px-16 py-2">
