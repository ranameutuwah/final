@extends('layouts.app', ['title' => 'Tambah Pengarang - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold  capitalize">TAMBAH PENGARANG</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.pengarang.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                            name="id" value="{{ old('id') }}" placeholder="Id pengarang">
                        @error('id')
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                            name="nama_pengarang" value="{{ old('nama_pengarang') }}" placeholder="nama Pengarang">
